...
int main()
{
    ...
    if (userType == 1)
    {
        ...
        listenObj.initializeWinsock();
        listenObj.createSocket();
        listenObj.bindSocket(); // I call the method to bind the socket
    ...
    else if (userType == 2)
    {
        ...
        sendObj.initializeWinsock();
        sendObj.createSocket();
